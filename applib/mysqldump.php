...
$file_name= $DIR_LOG . "sql_dump_". $myFile; // jmeno souboru pro DUMP
...
$dump_buffer="";
@$dbspojeni=mysql_connect($DB_SERVER,$DB_USER,$DB_PASS);
if (!$dbspojeni){
...
for ($i=0;$i<$num_tables;$i++){
	...
	//ktere tabulky zalohovat
	if ( strpos($table, 'in_game')===false || $table=='ligy'){
		continue;
	}
