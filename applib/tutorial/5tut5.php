<?php
	...
	$obsah .= '<tr><td></td><td>
	- výsledek útoků naleznete denním hlášení
	</td><td></td></tr>';
	
	$obsah .= '<tr><td></td><td>
	- nyní víte, jak dobýjet a bránit sektory
	</td><td></td></tr>';
	
	$obsah .= '<tr><td></td><td>
	- můžete pokračovat <a href="index.php?section=tutorial3&amp;page=tut1">následujícím tutoriálem</a>
	</td><td></td></tr>';
